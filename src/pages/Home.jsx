        ...
        <div id="bodyWrapper">
            ...
            <div className="content nuetral">
                <div className="con">
                    <div id="readme">
                        <h1 id="hello"></h1>
                        <p>Welcome to my personal website. This site is intended to showcase my porfolio, projects and blogs. It's also a handy way to get in contact with me and serves as a central hub for my professional online appearance.</p>
                        <p>My name is <code>Masum Ahmed</code> and I am a computer science major with a passion for programming and web development. I graduated from CUNY Hunter College and have a strong interest in web development and data science.</p>
